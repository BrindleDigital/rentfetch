...
function rentfetch_default_properties_admin_columns( $columns ) {
	...
	$columns = array(
		...
		'address'               => __( 'Address', 'rent-fetch' ),
		'city'                  => __( 'City', 'rent-fetch' ),
		'state'                 => __( 'State', 'rent-fetch' ),
		'zipcode'               => __( 'Zipcode', 'rent-fetch' ),
		'latitude'              => __( 'Latitude', 'rent-fetch' ),
		'longitude'             => __( 'Longitude', 'rent-fetch' ),
		'email'                 => __( 'Email', 'rent-fetch' ),
		'phone'                 => __( 'Phone', 'rent-fetch' ),
		'url'                   => __( 'URL', 'rent-fetch' ),
		'images'                => __( 'Images', 'rent-fetch' ),
		'description'           => __( 'Description', 'rent-fetch' ),
		'tour'                  => __( 'Tour', 'rent-fetch' ),
		'pets'                  => __( 'Pets', 'rent-fetch' ),
		'content_area'          => __( 'Content Area', 'rent-fetch' ),
		'yardi_property_images' => __( 'Images (Yardi)', 'rent-fetch' ),
		'property_source'       => __( 'Property Source', 'rent-fetch' ),
