...
function rentfetch_default_units_admin_columns( $columns ) {
	...
	$columns = array(
		...
		'unit_id'               => __( 'Unit ID', 'rent-fetch' ),
		'floorplan_id'          => __( 'Floorplan ID', 'rent-fetch' ),
		'floorplan_name'        => __( 'Floorplan Name', 'rent-fetch' ),
		'property_id'           => __( 'Property ID', 'rent-fetch' ),
		'apply_online_url'      => __( 'Apply URL', 'rent-fetch' ),
		'availability_date'     => __( 'Availability date', 'rent-fetch' ),
		'baths'                 => __( 'Baths', 'rent-fetch' ),
		'beds'                  => __( 'Beds', 'rent-fetch' ),
		'deposit'               => __( 'Deposit', 'rent-fetch' ),
		'minimum_rent'          => __( 'Min Rent', 'rent-fetch' ),
		'maximum_rent'          => __( 'Max Rent', 'rent-fetch' ),
		'sqrft'                 => __( 'Sqrft', 'rent-fetch' ),
		'specials'              => __( 'Specials', 'rent-fetch' ),
		'yardi_unit_image_urls' => __( 'Yardi image', 'rent-fetch' ),
		'unit_source'           => __( 'Integration', 'rent-fetch' ),
