...
function rentfetch_default_floorplans_admin_columns( $columns ) {
	...
	$columns = array(
		...
		'title'                 => __( 'Title', 'rent-fetch' ),
		'floorplan_source'      => __( 'Floorplan Source', 'rent-fetch' ),
		'property_id'           => __( 'Property ID', 'rent-fetch' ),
		'property_name'         => __( 'Property Name', 'rent-fetch' ),
		'floorplan_id'          => __( 'Floorplan ID', 'rent-fetch' ),
		'tour'                  => __( 'Tour', 'rent-fetch' ),
		'manual_images'         => __( 'Manual Images', 'rent-fetch' ),
		'floorplan_images'      => __( 'Synced Images', 'rent-fetch' ),
		'floorplan_description' => __( 'Floorplan Description', 'rent-fetch' ),
		'beds'                  => __( 'Beds', 'rent-fetch' ),
		'baths'                 => __( 'Baths', 'rent-fetch' ),
		'minimum_deposit'       => __( 'Min Deposit', 'rent-fetch' ),
		'maximum_deposit'       => __( 'Max Deposit', 'rent-fetch' ),
		'minimum_rent'          => __( 'Min Rent', 'rent-fetch' ),
		'maximum_rent'          => __( 'Max Rent', 'rent-fetch' ),
		'minimum_sqft'          => __( 'Min Sqrft', 'rent-fetch' ),
		'maximum_sqft'          => __( 'Max Sqrft', 'rent-fetch' ),
		'availability_date'     => __( 'Availability Date', 'rent-fetch' ),
		'has_specials'          => __( 'Has Specials', 'rent-fetch' ),
		'availability_url'      => __( 'Availability URL', 'rent-fetch' ),
		'available_units'       => __( 'Available Units', 'rent-fetch' ),
		'api_response'          => __( 'API response', 'rent-fetch' ),
	);
