	...
	<div class="row">
		...
		<div class="column">
			<ul class="radio">
				<li>
					<label>
						<input type="radio" name="rentfetch_options_property_pricing_display" id="rentfetch_options_property_pricing_display" value="range" <?php checked( get_option( 'rentfetch_options_property_pricing_display' ), 'range' ); ?>>
						Range (e.g. "$1999 to $2999")
					</label>
				</li>
				<li>
					<label>
						<input type="radio" name="rentfetch_options_property_pricing_display" id="rentfetch_options_property_pricing_display" value="minimum" <?php checked( get_option( 'rentfetch_options_property_pricing_display' ), 'minimum' ); ?>>
	...
	<div class="row">
		...
		<div class="column">
			<ul class="radio">
				<li>
					<label>
						<input type="radio" name="rentfetch_options_property_orderby" id="rentfetch_options_property_orderby" value="menu_order" <?php checked( get_option( 'rentfetch_options_property_orderby' ), 'menu_order' ); ?>>
						Menu order (use this if utilizing drag/drop reordering)
					</label>
				</li>
				<li>
					<label>
						<input type="radio" name="rentfetch_options_property_orderby" id="rentfetch_options_property_orderby" value="date" <?php checked( get_option( 'rentfetch_options_property_orderby' ), 'date' ); ?>>
						Publish date
					</label>
				</li>
				<li>
					<label>
						<input type="radio" name="rentfetch_options_property_orderby" id="rentfetch_options_property_orderby" value="modified" <?php checked( get_option( 'rentfetch_options_property_orderby' ), 'modified' ); ?>>
						Last modified date
					</label>
				</li>
				<li>
					<label>
						<input type="radio" name="rentfetch_options_property_orderby" id="rentfetch_options_property_orderby" value="ID" <?php checked( get_option( 'rentfetch_options_property_orderby' ), 'ID' ); ?>>
						Post ID number
					</label>
				</li>
				<li>
					<label>
						<input type="radio" name="rentfetch_options_property_orderby" id="rentfetch_options_property_orderby" value="title" <?php checked( get_option( 'rentfetch_options_property_orderby' ), 'title' ); ?>>
						Alphabetical, based on property name
					</label>
				</li>
				<li>
					<label>
						<input type="radio" name="rentfetch_options_property_orderby" id="rentfetch_options_property_orderby" value="name" <?php checked( get_option( 'rentfetch_options_property_orderby' ), 'name' ); ?>>
						Alphabetical, based on property slug
					</label>
				</li>
				<li>
					<label>
						<input type="radio" name="rentfetch_options_property_orderby" id="rentfetch_options_property_orderby" value="rand" <?php checked( get_option( 'rentfetch_options_property_orderby' ), 'rand' ); ?>>
						Randomize
					</label>
				</li>
			</ul>
	...
	<div class="row">
		...
		<div class="column">
			<ul class="radio">
				<li>
					<label>
						<input type="radio" name="rentfetch_options_property_order" id="rentfetch_options_property_order" value="ASC" <?php checked( get_option( 'rentfetch_options_property_order' ), 'ASC' ); ?>>
						Ascending
					</label>
				</li>
				<li>
					<label>
						<input type="radio" name="rentfetch_options_property_order" id="rentfetch_options_property_order" value="DESC" <?php checked( get_option( 'rentfetch_options_property_order' ), 'DESC' ); ?>>
						Descending
					</label>
				</li>
			</ul>
