	...
	?>
	 ...
	 <div class="row">
		...
		<div class="column">
			...
			<input type="text" name="options_maximum_number_of_properties_to_show" id="options_maximum_number_of_properties_to_show" value="<?php echo esc_attr( get_option( 'options_maximum_number_of_properties_to_show' ), '-1' ); ?>">
		</div>
	</div>
