...
function rentfetch_settings_floorplans_floorplan_embed() {
	...
	<div class="row">
		<div class="section">
			...
			<p>The default shortcode to display floor plans, showing the floor plans in a grid with search filters.</p>
			<p>
			...
			<p>
				<span class="shortcode"><!-- wp:shortcode -->[rentfetch_floorplansearch property_id=p1234]<!-- /wp:shortcode --></span>
				<span class="shortcode"><!-- wp:shortcode -->[rentfetch_floorplansearch property_id=p1234,p2345]<!-- /wp:shortcode --></span>
			</p>
		</div>
		...
		<div class="section">
			...
			<p>
				...
				<span class="shortcode"><!-- wp:shortcode -->[rentfetch_floorplans property_id=p1234,p5678 beds=2,3]<!-- /wp:shortcode --></span>
				<span class="shortcode"><!-- wp:shortcode -->[rentfetch_floorplans sort=beds]<!-- /wp:shortcode --></span>
				<span class="shortcode"><!-- wp:shortcode -->[rentfetch_floorplans sort=availability]<!-- /wp:shortcode --></span>
			</p>
