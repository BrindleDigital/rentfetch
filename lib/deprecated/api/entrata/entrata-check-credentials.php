...
function rentfetch_check_creds_entrata() {
    ...
    $entrata_user = get_option( 'rentfetch_options_entrata_integration_creds_entrata_user' );
    $entrata_pass = get_option( 'rentfetch_options_entrata_integration_creds_entrata_pass' );
