...
function rentfetch_enqueue_scripts_stylesheets() {
	...
	// Rent Fetch tooltip library.
	wp_register_script( 'rentfetch-tooltip', RENTFETCH_PATH . 'js/rentfetch-tooltip.js', array( 'jquery' ), RENTFETCH_VERSION, true );
	...
	wp_localize_script(
		...
		array(
			...
			'enableCacheConsoleLogging' => get_option( 'rentfetch_options_enable_cache_console_logging', '0' ) === '1',
		)
	);
