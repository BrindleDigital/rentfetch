...
if ( interface_exists( 'SEOPress\\Models\\GetTagValue' ) ) {
	$rentfetch_seopress_tag_class_files = array(
		'class-rentfetch-seopress-tag-floorplan-beds.php',
		'class-rentfetch-seopress-tag-floorplan-baths.php',
		'class-rentfetch-seopress-tag-floorplan-sqft.php',
		'class-rentfetch-seopress-tag-floorplan-pricing.php',
		'class-rentfetch-seopress-tag-city.php',
		'class-rentfetch-seopress-tag-state.php',
		'class-rentfetch-seopress-tag-zip.php',
	);

	foreach ( $rentfetch_seopress_tag_class_files as $rentfetch_seopress_tag_class_file ) {
		require_once __DIR__ . '/' . $rentfetch_seopress_tag_class_file;
	}
