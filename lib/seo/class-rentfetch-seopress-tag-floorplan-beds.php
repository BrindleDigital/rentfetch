...
if ( class_exists( 'Rentfetch_SEOPress_Tag_Base' ) && ! class_exists( 'Rentfetch_SEOPress_Tag_Floorplan_Beds' ) ) {
	/**
	 * Provides the floor plan beds value to SEOPress.
	 */
